...
public class h_line_2_hover : MonoBehaviour
{
    ...
    private void OnMouseOver()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (_0_KingDog_GameController.is_horizontal_line_2_connected)
            {
                audioSource.PlayOneShot(missClip);
            }
            else if (!_0_KingDog_GameController.is_horizontal_line_2_connected)
            {
                if (_0_KingDog_GameController.can_line_2_changed)
                {
                    createLine();
                }
                else if (!_0_KingDog_GameController.can_line_2_changed)
                {
                    audioSource.PlayOneShot(missClip);
                }
            }
    ...
    private void createLine()
    {
        ...
        _0_KingDog_GameController.is_horizontal_line_2_connected = true;
        Debug.Log($"下の横線は接続されているか？{_0_KingDog_GameController.is_horizontal_line_2_connected}");
    }
    ...
    private void deleteLine()
    {
        ...
        _0_KingDog_GameController.is_horizontal_line_2_connected = false;
        Debug.Log($"下の横線は接続されているか？{_0_KingDog_GameController.is_horizontal_line_2_connected}");
    }
}
