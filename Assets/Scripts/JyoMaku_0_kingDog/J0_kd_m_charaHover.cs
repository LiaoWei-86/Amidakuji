...
public class J0_kd_m_charaHover : MonoBehaviour
{
    ...
    public Dictionary<string, string[]> defaultCharacterInfoDict = new Dictionary<string, string[]>
    {
        ...
        { "chinaGirl", new string[] { "遠い東の人 林雪", "○ 故郷に帰えられる船を探している", "○ 神秘的なペットを飼っている", "○ 遠東の国の秘密を知っている" } }
    };
    // Start is called before the first frame update
    void Start()
    {
        if (_0_KingDog_GameController == null)
        {
            _0_KingDog_GameController = FindObjectOfType<JyoMaku_0_kingDog_gameController>();
        }
        ...
        // フォントの設定
        dotFont = _0_KingDog_GameController.dotFont;
    }
