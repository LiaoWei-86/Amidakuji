...
public class Act_1_3_charaHoverArea : MonoBehaviour
{
    ...
    public Dictionary<string, string[]> defaultCharacterInfoDict = new Dictionary<string, string[]>
    {
        ...
        { "pirate", new string[] { "海賊", "○ 養女が一人いる", "○ 財宝を狂ったように渇望し、誰であろうと奪いに行く", "○ 財宝のために多くの人を殺した" } },
    ...
    void Start()
    {
        ...
        {
            Act_1_3_gameControllerScript = FindObjectOfType<Act_1_3_gameController>();
        }
        ...
        // フォントの設定
        dotFont = Act_1_3_gameControllerScript.dotFont;
    }
