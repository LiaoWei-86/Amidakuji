...
public class Act_1_35_gameController : MonoBehaviour
{
    public GameObject character1;
    public GameObject character2;

    public PlayableDirector Act_1_35starting;
    ...
    void Start()
    {
        if (Act_1_35starting != null)
        {
            Act_1_35starting.stopped += OnPlayableDirectorStopped;
        }
    ...
    void CreateHoverAreaCharacter(GameObject character)
    {
        ...
        Act_1_35_hoverArea Act_1_25_hoverAreaScript = character.AddComponent<Act_1_35_hoverArea>();
