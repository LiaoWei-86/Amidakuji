...
public class Act_1_35_hoverArea : MonoBehaviour
{
    ...
    public Act_1_35_gameController Act_1_35_gameControllerScript;

    // Start is called before the first frame update
    void Start()
    {
        if (Act_1_35_gameControllerScript == null)
        {
            Act_1_35_gameControllerScript = FindObjectOfType<Act_1_35_gameController>();
        }
    }
