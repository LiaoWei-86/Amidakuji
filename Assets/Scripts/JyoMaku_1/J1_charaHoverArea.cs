...
public class J1_charaHoverArea : MonoBehaviour
{
    ...
    public J1_GameController J1_GameControllerScript;
    ...
    void Start()
    {
        ...
        {
            J1_GameControllerScript = FindObjectOfType<J1_GameController>();
        }
        ...
        // フォントの設定
        dotFont = J1_GameControllerScript.dotFont;
    }
