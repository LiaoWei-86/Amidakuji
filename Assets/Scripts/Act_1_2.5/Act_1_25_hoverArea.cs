...
public class Act_1_25_hoverArea : MonoBehaviour
{
    ...
    public Act_1_25_gameController Act_1_25_gameControllerScript;

    // Start is called before the first frame update
    void Start()
    {
        if (Act_1_25_gameControllerScript == null)
        {
            Act_1_25_gameControllerScript = FindObjectOfType<Act_1_25_gameController>();
        }
    }
