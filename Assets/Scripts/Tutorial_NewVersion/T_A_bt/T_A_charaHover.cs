...
public class T_A_charaHover : MonoBehaviour
{
    ...
    public T_Again t_a_GameController_script;
    ...
    void Start()
    {
        ...
        {
            t_a_GameController_script = FindObjectOfType<T_Again>();
        }
        ...
        // フォントの設定
        dotFont = t_a_GameController_script.dotFont;
    }
