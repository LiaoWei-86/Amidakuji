...
public class Act_1_4_charaHoverArea : MonoBehaviour
{
    ...
    public Dictionary<string, string[]> defaultCharacterInfoDict = new Dictionary<string, string[]>
    {
        ...
        { "king", new string[] { "国王", "○ 庭師の少年を信頼している", "○ 不死薬を探し求めている", "○ 城の設備のために専属技師を雇っている" } },
    ...
    void Start()
    {
        ...
        {
            Act_1_4_gameControllerScript = FindObjectOfType<Act_1_4_gameController>();
        }
        ...
        // フォントの設定
        dotFont = Act_1_4_gameControllerScript.dotFont;
