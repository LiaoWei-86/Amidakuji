...
public class J_A1_1_hoverArea : MonoBehaviour
{
    ...
    public JyoMakuToAct1 JyoMakuToAct1Script;

    // Start is called before the first frame update
    void Start()
    {
        if (JyoMakuToAct1Script == null)
        {
            JyoMakuToAct1Script = FindObjectOfType<JyoMakuToAct1>();
        }
    }
