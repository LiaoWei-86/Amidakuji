...
public class J0_charaHoverArea : MonoBehaviour
{
    ...
    public J0_gameController J0_gameControllerScript;
    ...
    void Start()
    {
        ...
        {
            J0_gameControllerScript = FindObjectOfType<J0_gameController>();
        }
        ...
        // フォントの設定
        dotFont = J0_gameControllerScript.dotFont;
    }
