...
public class J0_5_hoverChara : MonoBehaviour
{
    ...
    public J0_5_GameController J0_5_GameControllerScript;

    // Start is called before the first frame update
    void Start()
    {
        if (J0_5_GameControllerScript == null)
        {
            J0_5_GameControllerScript = FindObjectOfType<J0_5_GameController>();
        }
    }
